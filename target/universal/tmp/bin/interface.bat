@REM interface launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM INTERFACE_config.txt found in the INTERFACE_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%INTERFACE_HOME%"=="" set "INTERFACE_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%INTERFACE_HOME%\lib\"
...
set "CFG_FILE=%INTERFACE_HOME%\INTERFACE_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running interface.
  echo.
