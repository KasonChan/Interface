...
// @LINE:40
private[this] lazy val controllers_Submissions_submit13 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("submission"))))
        

// @LINE:42
private[this] lazy val controllers_Files_upload14 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("submission"))))
...
// @LINE:40
case controllers_Submissions_submit13(params) => {
   call { 
...
// @LINE:42
case controllers_Files_upload14(params) => {
   call { 
