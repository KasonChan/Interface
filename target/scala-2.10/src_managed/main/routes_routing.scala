...
// @LINE:35
private[this] lazy val controllers_Application_destination11 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("destination"))))
        

// @LINE:37
private[this] lazy val controllers_Destinations_create12 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("destination"))))
        

// @LINE:40
private[this] lazy val controllers_Destinations_list13 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("destinations"))))
...
// @LINE:35
case controllers_Application_destination11(params) => {
   call { 
...
// @LINE:37
case controllers_Destinations_create12(params) => {
   call { 
...
// @LINE:40
case controllers_Destinations_list13(params) => {
   call { 
