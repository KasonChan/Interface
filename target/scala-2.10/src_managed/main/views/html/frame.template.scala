  ...
  <div class="application_wrapper">
    ...
    <div id="header">
      <div class="container">
        <!-- Application name -->
        <h1>
          <a href=""""),_display_(Seq[Any](/*35.21*/routes/*35.27*/.Application.index)),format.raw/*35.45*/("""">"""),_display_(Seq[Any](/*35.48*/title)),format.raw/*35.53*/("""</a>
        </h1>
      </div>
    </div>
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    -- GENERATED --
                    DATE: Fri Jul 11 13:57:41 CDT 2014
