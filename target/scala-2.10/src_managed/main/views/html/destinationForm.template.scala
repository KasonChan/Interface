...
<div id="section">
  <div id="container">
    <form method="post" id="destination" action=""""),_display_(Seq[Any](/*41.51*/routes/*41.57*/.Destinations.create)),format.raw/*41.77*/("""">
      ...
      <!-- Submit -->
      <input type="submit" id="destinationSubmit" value=""""),_display_(Seq[Any](/*73.59*/Messages("destination.label.submit"))),format.raw/*73.95*/("""">
    </form>
  </div>
</div>
